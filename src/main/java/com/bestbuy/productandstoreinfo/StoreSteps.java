...
public class StoreSteps {
    @Step("Creating student with name : {0}, address: {1},city: {2},state: {3},zip: {4},type:{5},address2:{6},lat:{7},lng:{8}")

    public ValidatableResponse createStore(String name, String address, String city, String state, String zip, String type, String address2, int lat, int lng){
