Feature: BestBuy Application
  ...
  Scenario Outline: Create a new product & verify if the product is added
    ...
    Examples:
      ...
      | mann  | prime | abcd | auto        | best  | 10    | 11       | audi         |

  Scenario: Update an exciting product & verify that product  is updated
    When I update a product with product Id and give information ProductId "673890" name "mannanna", type "HardGood", upc "abcd", description "auto", model "best", price  "10", shipping "11" , manufacturer "tesla"
