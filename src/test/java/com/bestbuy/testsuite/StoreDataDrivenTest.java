...
@UseTestDataFrom("src/test/java/resources/propertyfile/testdata/storeinfo.csv")
...
public class StoreDataDrivenTest extends TestBase {
    ...
    public void test001() {
        ...
        storeSteps.createStore(name,address,city,state,zip,type,address2,lat,lng);
